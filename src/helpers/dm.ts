...
export function DATAMatrix(Q: string) {
  var M: any[][] = [],
    xx = 0,
    yy = 0,
    ...
    toText = function (t: string, s: number[]) {
      var i,
        j,
        cc = 0,
        cw = 0,
    ...
    encodeMsg = function (text: string, rct: any) {
      ...
      for (i = 0; i < l; r -= s, c += s) {
        if (r == h - 3 && c == -1)
          ...
          if (r == h - 2 && c == 0 && w & 3)
            ...
            continue;
          /* omit corner D */ else k = b; /* nominal L - shape layout */
        }
  ...
  return (function () {
    ...
    function svg(
      ...
      n = document.createElementNS(ns, n as any);
